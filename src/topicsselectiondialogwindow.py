from PyQt5.QtWidgets import QDialog, QGridLayout, QListWidget, QPushButton, QListWidgetItem, QInputDialog, QMessageBox
...
class TopicsSelectionDialogWindow(QDialog):
    ...
    def insertNewTopic(self):
        ...
        # Vérifier que le sujet entré correspond à une catégorie sous Wikipédia
        ...
        if result["RETURN"] == "TOO MANY TOPICS":
        ...
        elif result["RETURN"] == "NO CONNECTION":
    ...
    def deleteTopic(self):
        ...
        #self.current_settings["TOPICS"].remove(str(current_item_name))
        
        
    
    def validateTopicsSelection(self):
        
        # Enregistrer tous les sujets de la liste
        self.current_settings["TOPICS"] = []
        
        for x in range(self.topics_list.count()):
            
            self.current_settings["TOPICS"].append(str(self.topics_list.item(x).text()))
        self.accept()
